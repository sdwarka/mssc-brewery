...
public class BeerController {
    ...
    public ResponseEntity createBeer(@RequestBody BeerDto beerDto) {
        ...
        // return the location of the newly created beer
        HttpHeaders hdrs = new HttpHeaders();
        hdrs.add("Location", "/api/v1/beer/" + savedDto.getId());
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT) // alt way of doing as in PUT
